...
ts = '''import { OfficialProfile, StateData } from '../types';
...
export const NIGERIA_SENATORS_MASTER: Record<string, any[]> = ''' + json.dumps(full_109_senators, indent=2) + ''';

export const NIGERIA_REPRESENTATIVES_MASTER: Record<string, any[]> = ''' + json.dumps(reps_by_state, indent=2) + ''';
...
print("Emitted full 109 senators and executive manifestos master bundle!")
