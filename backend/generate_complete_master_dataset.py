# Comprehensive master generator for all 36 Nigerian state leaders, senators, and reps
import json

output_file = r"C:\Users\dimvi\projects\wsfu\web\src\lib\officials_data.ts"

script_code = '''// Authoritative Master Leadership & Tracked Promises Dataset
// Real Nigerian Executive Governors, 10th Senate Lawmakers, and Federal Representatives
import { OfficialProfile, TrackedPromise, StateData } from '../types';
