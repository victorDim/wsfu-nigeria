...
all_states = ns['ALL_NIGERIAN_STATES'] if 'ALL_NIGERIAN_STATES' in ns else None
...
print("Generated clean JSON-serialized officials_data.ts with exact NDHS 2024 figures!")
