...
export async function callAIAsk(
  ...
  if (upper.includes('SECURITY') || upper.includes('POLICE') || upper.includes('ARMY') || upper.includes('MILITARY') || upper.includes('BANDIT') || upper.includes('KIDNAP') || upper.includes('INSECURITY')) {
